...
public interface TSP {
	 ...
	 */
	public abstract Boolean getTempsLimiteAtteint();
	 ...
	 */
	public abstract void chercheSolution(int tpsLimite, int nbSommets, int[][] cout, int[] duree);
	
	/**
	 * @param i
	 * @return le sommet visite en i-eme position dans la solution calculee par chercheSolution
	 */
	public abstract Integer getMeilleureSolution(int i);
	
	/** 
	 * @return la duree de la solution calculee par chercheSolution
	 */
	public abstract int getCoutMeilleureSolution();
	
	/** 
	 * Arrête le calcule d'une solution
	 */
	
	public abstract void arreterCalcul(Boolean valeur);
}
